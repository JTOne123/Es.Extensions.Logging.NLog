...
namespace Es.Extensions.Logging.NLog
{
    ...
    internal class NLogLogger : Microsoft.Extensions.Logging.ILogger
    {
        ...
        private static readonly object EmptyEventId = default(Microsoft.Extensions.Logging.EventId);    // Cache boxing of empty EventId-struct
        private static readonly object ZeroEventId = default(Microsoft.Extensions.Logging.EventId).Id;  // Cache boxing of zero EventId-Value
        ...
        private void CaptureEventId(LogEventInfo eventInfo, Microsoft.Extensions.Logging.EventId eventId)
        {
